...
#read REACT_APP_API_URL from build arguments of Docker
ARG REACT_APP_SYSTEM_API_KEY=${REACT_APP_SYSTEM_API_KEY}
ENV REACT_APP_SYSTEM_API_KEY=${REACT_APP_SYSTEM_API_KEY}

#read REACT_APP_BOOKING_API_KEY from build arguments of Docker
