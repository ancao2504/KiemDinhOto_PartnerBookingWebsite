...
ARG REACT_APP_URL_WEB_TTDK=${REACT_APP_URL_WEB_TTDK}
ENV REACT_APP_URL_WEB_TTDK=${REACT_APP_URL_WEB_TTDK}

ARG REACT_APP_APIKEY=${REACT_APP_APIKEY}
ENV REACT_APP_APIKEY=${REACT_APP_APIKEY}

ARG REACT_APP_URL_WEB_PHATNGUOI=${REACT_APP_URL_WEB_PHATNGUOI}
ENV REACT_APP_URL_WEB_PHATNGUOI=${REACT_APP_URL_WEB_PHATNGUOI}

ARG REACT_APP_URL_WEB_BAOHIEM=${REACT_APP_URL_WEB_BAOHIEM}
ENV REACT_APP_URL_WEB_BAOHIEM=${REACT_APP_URL_WEB_BAOHIEM}

ARG REACT_APP_HOME_MINIAPP_HEADER_TITLE=${REACT_APP_HOME_MINIAPP_HEADER_TITLE}
ENV REACT_APP_HOME_MINIAPP_HEADER_TITLE=${REACT_APP_HOME_MINIAPP_HEADER_TITLE}

ARG REACT_APP_HOME_MINIAPP_HEADER_EXPAND=${REACT_APP_HOME_MINIAPP_HEADER_EXPAND}
ENV REACT_APP_HOME_MINIAPP_HEADER_EXPAND=${REACT_APP_HOME_MINIAPP_HEADER_EXPAND}

ARG REACT_APP_DEFAULT_HOME_LAYOUT=${REACT_APP_DEFAULT_HOME_LAYOUT}
ENV REACT_APP_DEFAULT_HOME_LAYOUT=${REACT_APP_DEFAULT_HOME_LAYOUT}

ARG REACT_APP_TELEGRAM_CHAT_ID=${REACT_APP_TELEGRAM_CHAT_ID}
ENV REACT_APP_TELEGRAM_CHAT_ID=${REACT_APP_TELEGRAM_CHAT_ID}

ARG REACT_APP_TELEGRAM_BOT_TOKEN=${REACT_APP_TELEGRAM_BOT_TOKEN}
ENV REACT_APP_TELEGRAM_BOT_TOKEN=${REACT_APP_TELEGRAM_BOT_TOKEN}

ARG REACT_APP_ZALO_AUTH_ENABLE=${REACT_APP_ZALO_AUTH_ENABLE}
ENV REACT_APP_ZALO_AUTH_ENABLE=${REACT_APP_ZALO_AUTH_ENABLE}

ARG REACT_APP_MINIAPP_ZALOPAY=${REACT_APP_MINIAPP_ZALOPAY}
ENV REACT_APP_MINIAPP_ZALOPAY=${REACT_APP_MINIAPP_ZALOPAY}

ARG REACT_APP_MINIAPP_GTELPAY=${REACT_APP_MINIAPP_GTELPAY}
ENV REACT_APP_MINIAPP_GTELPAY=${REACT_APP_MINIAPP_GTELPAY}
